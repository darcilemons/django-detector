...
class Itens_facial(models.Model):
    cond_id = models.ForeignKey(Conds, on_delete=models.CASCADE, related_name='itens', verbose_name='Condomínio')
    item = models.CharField(max_length=100, verbose_name="Item")
    iplocal = models.CharField(max_length=15, verbose_name="IP Local")
    link = models.CharField(max_length=15, verbose_name="Link de acesso")
